...
// Protected routes
router.post("/signout", auth_middleware_1.customerAuthMiddleware, auth_controller_1.AuthController.signOut);
router.get("/me", auth_middleware_1.customerAuthMiddleware, auth_controller_1.AuthController.getMe);
router.put("/profile", auth_middleware_1.customerAuthMiddleware, (0, validation_middleware_1.validateBody)(auth_validators_1.updateProfileSchema), auth_controller_1.AuthController.updateProfile);
router.put("/change-password", auth_middleware_1.customerAuthMiddleware, rate_limit_middleware_1.passwordResetLimiter, (0, validation_middleware_1.validateBody)(auth_validators_1.changePasswordSchema), auth_controller_1.AuthController.changePassword);
