...
exports.ComboOffersController = void 0;
const database_1 = require("../config/database");
const error_middleware_1 = require("../middleware/error.middleware");
class ComboOffersController {
}
exports.ComboOffersController = ComboOffersController;
_a = ComboOffersController;
// Get all combo offers
ComboOffersController.getAllComboOffers = (0, error_middleware_1.asyncHandler)(async (req, res, next) => {
...
ComboOffersController.getComboOfferById = (0, error_middleware_1.asyncHandler)(async (req, res, next) => {
    const { id } = req.params;
    ...
    if (result.recordset.length === 0) {
        throw new error_middleware_1.ApiError(404, "Combo offer not found");
    }
    res.json({
        success: true,
        data: {
...
// Create combo offer
ComboOffersController.createComboOffer = (0, error_middleware_1.asyncHandler)(async (req, res, next) => {
    const { title_ar, title_en, description_ar, description_en, image_url, price, original_price, is_active = true, } = req.body;
    const result = await database_1.pool
        .request()
...
// Update combo offer
ComboOffersController.updateComboOffer = (0, error_middleware_1.asyncHandler)(async (req, res, next) => {
    const { id } = req.params;
    const { title_ar, title_en, description_ar, description_en, image_url, price, original_price, is_active, } = req.body;
...
// Delete combo offer
ComboOffersController.deleteComboOffer = (0, error_middleware_1.asyncHandler)(async (req, res, next) => {
    const { id } = req.params;
    const result = await database_1.pool
        .request()
        .input("id", id)
...
//# sourceMappingURL=comboOffers.controller.js.map